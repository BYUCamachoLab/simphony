...
class DCHalfRing_Model(components.SimulationModel):
    @staticmethod
    def get_s_parameters(numports: int=4):
        ...
        """
        filename = os.path.join(os.path.dirname(os.path.realpath(__file__)), "te_ebeam_dc_halfring_straight_gap=30nm_radius=3um_width=520nm_thickness=210nm_CoupleLength=0um.dat")
        F = []
        S = []
