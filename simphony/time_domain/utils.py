...
def pole_residue_to_time_system(pole_residue_model: PoleResidueModel,t) -> TimeSystem:
    if isinstance(pole_residue_model, IIRModelBaseband):
        return IIRModelBaseband_to_time_system(pole_residue_model,t)
    if isinstance(pole_residue_model, CVFModelBaseband):
        return CVF_Baseband_to_time_system(pole_residue_model,t)
