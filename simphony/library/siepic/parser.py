...
class ParamVisitor(NodeVisitor):
    def visit_file(self, node: Node, visited_children: Union[List[Union[Node, List[Dict[str, Union[int, str, List[float], List[complex128]]]]]], List[Union[List[List[Union[Node, RegexNode, List[RegexNode]]]], List[Dict[str, Union[int, str, List[float], List[complex128]]]], Node]]]) -> List[Dict[str, Union[int, str, List[float], List[complex128]]]]:
        """
        Handles the grammar:
            file        = paramset* ws*
    ...
    def visit_paramset(self, node: Node, visited_children: List[Union[Dict[str, Union[int, str]], List[Union[Node, float, List[RegexNode]]], List[Tuple[float, complex128]], Node]]) -> Dict[str, Union[int, str, List[float], List[complex128]]]:
        """
        Handles the grammar:
            paramset    = header shape datapoint* ws*
    ...
    def visit_header(self, node: Node, visited_children: List[Union[Node, int, str, float, List[RegexNode]]]) -> Dict[str, Union[int, str]]:
        """
        Handles the grammar:
            header      = lpar port comma mode comma number comma port comma number comma type rpar ws*
    ...
    def visit_datapoint(self, node: Node, visited_children: List[Union[float, List[RegexNode]]]) -> Tuple[float, complex128]:
        """
        Handles the grammar:
            datapoint   = number ws+ number ws+ number ws*
    ...
    def visit_port(self, node: Node, visited_children: List[Union[RegexNode, Node, float]]) -> int:
        """
        Handles the grammar:
            port        = quote "port" ws number quote
    ...
    def visit_mode(self, node: Node, visited_children: List[Union[List[RegexNode], RegexNode]]) -> str:
        """
        Handles the grammar:
            mode        = quote? string quote?
    ...
    def visit_type(self, node: Node, visited_children: List[Union[List[RegexNode], RegexNode]]) -> str:
        """
        Handles the grammar:
            type        = quote? string quote?
    ...
    def generic_visit(self, node: Union[Node, RegexNode], visited_children: Any) -> Any:
        """The generic visit method."""
        return visited_children or node


def read_params(filename: str) -> List[Dict[str, Union[int, str, List[float], List[complex128]]]]:
    """
    Parameters
    ----------
    filename : str
...
def build_matrix(dicts: List[Dict[str, Union[int, str, List[float], List[complex128]]]]) -> Tuple[List[float], ndarray]:
