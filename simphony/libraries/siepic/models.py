...
class DirectionalCoupler(Model):
    ...
    def _generate_parameter_sets(cls) -> pd.DataFrame:
        ...
        path = resolve_source_filepath("ebeam_dc_te1550")
    ...
    def s_params(self, wl):
        file = resolve_source_filepath(self._datafile)
        header, data = load_sparams(file)
...
class HalfRing(Model):
    ...
    def _generate_parameter_sets(cls) -> pd.DataFrame:
        ...
        path = resolve_source_filepath("ebeam_dc_halfring_straight")
...
class Taper(Model):
    ...
    def _generate_parameter_sets(cls) -> pd.DataFrame:
        ...
        path = resolve_source_filepath("ebeam_taper_te1550")
...
class Waveguide(Model):
    ...
    def _generate_parameter_sets(cls) -> pd.DataFrame:
        ...
        path = resolve_source_filepath("wg_integral_source")
