...
circuit.add([
    ('input', ebeam.ebeam_gc_te1550()),
    ('output', ebeam.ebeam_gc_te1550()),
    ('splitter', ebeam.ebeam_y_1550()),
    ('recombiner', ebeam.ebeam_y_1550()),
    ('wg_long', ebeam.ebeam_wg_integral_1550(length=150e-6)), # can optionally include ne=10.1, ng=1.3
    ('wg_short', ebeam.ebeam_wg_integral_1550(length=50e-6)),
])
